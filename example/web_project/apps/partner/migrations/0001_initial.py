    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliate', models.ForeignKey(to='partner.Affiliate', on_delete=models.CASCADE)),
                ('bought_by', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
